...
ENter PRN No. after do you want insert:2
...
Enter PRN no. of member to be deleted: 1
...
Total members(including President & Secretary): 2
1.Create
2.Insert President
3.Insert secretary
4.insert after position(member)
